  ...
  return (
    <div className="App">
      ...
      <Container fluid="md" style={{ marginTop: "70px", marginLeft:"150px"}}>
        ...
        <Container fluid style={{backgroundColor:'#007BFF', color:'white', marginTop:'100px', height:'178px', Padding:'40px 0'}}>
          <Row style={{ marginLeft:'174px' }}>
            <Col >
            <h1 style={{marginTop:'40px', fontSize:"60px"}}>$657B</h1>
            <h6 style={{color:'grey'}}>Quarterly volume traded</h6>
            </Col>
            <Col>
            <h1 style={{marginTop:'40px', fontSize:"60px"}}>100+</h1>
            <h6 style={{color:'grey'}}>Countries supported</h6>
            </Col>
            <Col>
            <h1 style={{marginTop:'40px', fontSize:"60px"}}>56+M</h1>
            <h6 style={{color:'grey'}}>Verified users</h6>
            </Col>
          </Row>
       </Container>
  </div>     
